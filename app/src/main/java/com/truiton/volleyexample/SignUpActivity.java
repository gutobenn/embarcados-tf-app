            ...
            try {
                ...
                CustomJSONObjectRequest sr = new CustomJSONObjectRequest(Request.Method.POST, url, jsonParams, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            JSONObject headers = ((JSONObject) response).getJSONObject("headers");

                            SharedPreferences preferences =
                                    getSharedPreferences("embarcados_preferences", MODE_PRIVATE);
                            SharedPreferences.Editor editor = preferences.edit();
                            editor.putString("client", headers.getString("client"));
                            editor.putString("access-token", headers.getString("access-token"));
